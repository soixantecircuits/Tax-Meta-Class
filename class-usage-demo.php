...
if (is_admin()){
   ...
   */
  $config = array(
    'id' => 'category_custom_meta_box',          // meta box id, unique per meta box
    'title' => 'Category Custom Meta Box',          // meta box title
...
//  $my_meta->addColor($prefix.'color_field_id',array('name'=> __('My Color ','tax-meta')));
  //Image field
  $my_meta->addImage($prefix.'image_field_id',array('name'=> __('Image ','tax-meta')));
  //file upload field
...
//  $repeater_fields[] = $my_meta->addCheckbox($prefix.'re_checkbox_field_id',array('name'=> __('My Checkbox ','tax-meta')),true);
  $repeater_fields[] = $my_meta->addImage($prefix.'image_field_id',array('name'=> __('Image ','tax-meta')),true);
